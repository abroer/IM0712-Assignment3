...
The correlation between all the columns has also been visualized in figure \ref{fig:correlation-matrix} and investigated. The following findings emerged:
\begin{itemize}
...
\begin{figure}
	...
	\caption{Correlation between the columns}
